...
<trak_integration>
**{{PROJECT_NAME}}-specific conventions**: [references/trak-conventions.md](references/trak-conventions.md)
- Model: TOUJOURS `opus` pour les subagents {{PROJECT_NAME}}
- Tools: JAMAIS de restrictions - tous les tools autorises
- Specialisation: Dans les INSTRUCTIONS, pas les permissions
- TDD: Obligatoire pour chaque critere d'acceptance
- Structure XML avec sections {{PROJECT_NAME}} specifiques
</trak_integration>
