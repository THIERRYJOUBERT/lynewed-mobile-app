...
✅ ALWAYS proposer decomposition pour validation utilisateur
...
✅ ALWAYS mettre a jour TRACKING.md de l'Epic
</critical_rule>
...
| {approved_stories} | array | Stories validees par user |
...
|------|------|---------|------------------|
| 00 | step-00-init.md | Verifier Epic + capturer contexte | ✓ Epic existe et lisible |
| 01 | step-01-analyze.md | Analyser Epic + extraire scope | ✓ Scope compris |
| 02 | step-02-propose.md | Proposer decomposition INVEST | ✓ Stories proposees |
| 03 | step-03-generate.md | Generer fichiers story | ✓ Fichiers crees |
| 04 | step-04-validate.md | Valider + mettre a jour TRACKING | ✓ TRACKING.md a jour |
| 05 | (inline) | Finalization intelligente | Propose sync si pertinent |
</step_files>

<execution_rules>
1. **Progressive Loading**: Load one step at a time
2. **User Validation**: Checkpoint obligatoire apres step-02 (proposition)
...
8. **Intelligent Finalization**: After step-04, propose sync based on work done (see workflow-finalization pattern)
</execution_rules>
...
✅ TRACKING.md de l'Epic mis a jour
✅ Stories prets pour /dev-story
</success_criteria>

<failure_modes>
❌ Epic non trouve → Fallback: AskUserQuestion pour Epic correct
...
│       ↓           ✓ Stories INVEST validees                       │
│                                                                   │
│  03. GENERATE    → Creer fichiers story                           │
│       ↓           ✓ Fichiers .md generes                          │
│                                                                   │
│  04. VALIDATE    → Verifier conflits + update TRACKING            │
│       ↓           ✓ Tout coherent et documente                    │
│                                                                   │
│  05. FINALIZE    → Propose sync (intelligent)                     │
│                    SI stories créées:                             │
│                      → AskUserQuestion: sync references?          │
│                                                                   │
...
Ce workflow est SUPERVISED (checkpoint à step-02), donc proposer à l'utilisateur :
