...
class MessagesBridesWidget extends StatefulWidget {
  const MessagesBridesWidget({super.key});

  static String routeName = 'MessagesBrides';
  static String routePath = '/messagesBrides';

  @override
  State<MessagesBridesWidget> createState() => _MessagesBridesWidgetState();
}

class _MessagesBridesWidgetState extends State<MessagesBridesWidget> {
  late MessagesBridesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MessagesBridesModel());
