...
import 'messages_pro_widget.dart' show MessagesProWidget;
import 'package:flutter/material.dart';

class MessagesProModel extends FlutterFlowModel<MessagesProWidget> {
  ...
  // Stores action output result for [Custom Action - getRoomsWithUnreadCountsAction] action in MessagesPro widget.
  InboxResultStruct? inboxResult;
  // Stores action output result for [Custom Action - getPendingContactRequestsAction] action in MessagesPro widget.
  ...
  // Stores action output result for [Custom Action - getRoomsWithUnreadCountsAction] action in Container widget.
