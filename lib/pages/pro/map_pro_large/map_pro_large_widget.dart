...
class MapProLargeWidget extends StatefulWidget {
  ...
  @override
  State<MapProLargeWidget> createState() => _MapProLargeWidgetState();
}

class _MapProLargeWidgetState extends State<MapProLargeWidget> {
  late MapProLargeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MapProLargeModel());
