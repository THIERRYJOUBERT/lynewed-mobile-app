/// Marketplace Buyer CGVU Dialog - Terms acceptance with scroll requirement.
///
/// Displays the marketplace buyer terms with a scroll-to-unlock checkbox.
...
/// Dialog for accepting marketplace buyer CGVU (Terms and Conditions).
///
/// Features:
...
class CgvuBuyerDialog extends StatefulWidget {
  /// Creates a marketplace buyer CGVU dialog.
  const CgvuBuyerDialog({
    super.key,
  ...
  @override
  State<CgvuBuyerDialog> createState() => _CgvuBuyerDialogState();
}

class _CgvuBuyerDialogState extends State<CgvuBuyerDialog> {
  ...
  Future<void> _onAccept() async {
    ...
    final result = await _acceptCgvuUseCase(
      cgvuType: marketplaceBuyerCgvuType,
      cgvuVersion: marketplaceBuyerCgvuVersion,
    );
...
/// Shows the marketplace buyer CGVU dialog.
///
/// Returns true if user accepted, false if dismissed.
Future<bool> showCgvuBuyerDialog({
  ...
  final result = await showDialog<bool>(
    ...
    builder: (context) => CgvuBuyerDialog(
