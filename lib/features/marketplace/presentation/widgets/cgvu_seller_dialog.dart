/// Marketplace Seller CGVU Dialog - Terms acceptance with scroll requirement.
///
/// Displays the marketplace seller terms with a scroll-to-unlock checkbox.
...
/// Dialog for accepting marketplace seller CGVU (Terms and Conditions).
///
/// Features:
...
class CgvuSellerDialog extends StatefulWidget {
  /// Creates a marketplace seller CGVU dialog.
  const CgvuSellerDialog({
    super.key,
  ...
  @override
  State<CgvuSellerDialog> createState() => _CgvuSellerDialogState();
}

class _CgvuSellerDialogState extends State<CgvuSellerDialog> {
  ...
  void initState() {
    super.initState();
    _acceptCgvuUseCase =
        widget.acceptCgvuUseCase ?? const AcceptCgvuUseCase();
  ...
  Future<void> _onAccept() async {
    ...
    final result = await _acceptCgvuUseCase(
      cgvuType: marketplaceSellerCgvuType,
      cgvuVersion: marketplaceSellerCgvuVersion,
    );
...
/// Shows the marketplace seller CGVU dialog.
///
/// Returns true if user accepted, false if dismissed.
Future<bool> showCgvuSellerDialog({
  ...
  final result = await showDialog<bool>(
    ...
    builder: (context) => CgvuSellerDialog(
